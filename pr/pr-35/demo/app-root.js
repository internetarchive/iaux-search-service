 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */class Yt{handleAttributeExpressions(e,t,i,s){const n=t[0];return n==="."?new Gt(e,t.slice(1),i).parts:n==="@"?[new Zt(e,t.slice(1),s.eventContext)]:n==="?"?[new Jt(e,t.slice(1),i)]:new kt(e,t,i).parts}handleTextExpression(e){return new be(e)}}const Qt=new Yt;/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const it=new WeakMap,ti=(r,e,t)=>{let i=it.get(e);i===void 0&&(Mt(e,e.firstChild),it.set(e,i=new be(Object.assign({templateFactory:ei},t))),i.appendInto(e)),i.setValue(r),i.commit()};/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
