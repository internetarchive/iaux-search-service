 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */class Gt{handleAttributeExpressions(e,t,i,s){const r=t[0];return r==="."?new zt(e,t.slice(1),i).parts:r==="@"?[new qt(e,t.slice(1),s.eventContext)]:r==="?"?[new jt(e,t.slice(1),i)]:new At(e,t,i).parts}handleTextExpression(e){return new we(e)}}const Jt=new Gt;/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function Kt(n){let e=Xe.get(n.type);e===void 0&&(e={stringsArray:new WeakMap,keyString:new Map},Xe.set(n.type,e));let t=e.stringsArray.get(n.strings);if(t!==void 0)return t;const i=n.strings.join(P);return t=e.keyString.get(i),t===void 0&&(t=new Vt(n,n.getTemplateElement()),e.keyString.set(i,t)),e.stringsArray.set(n.strings,t),t}const Xe=new Map;/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const Ye=new WeakMap,Zt=(n,e,t)=>{let i=Ye.get(e);i===void 0&&(yt(e,e.firstChild),Ye.set(e,i=new we(Object.assign({templateFactory:Kt},t))),i.appendInto(e)),i.setValue(n),i.commit()};/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */typeof window!="undefined"&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.4.1");const Xt=(n,...e)=>new bt(n,e,"html",Jt);/*! *****************************************************************************
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ke;const _e=window,G=_e.trustedTypes,ut=G?G.createPolicy("lit-html",{createHTML:n=>n}):void 0,R=`lit$${(Math.random()+"").slice(9)}$`,Ct="?"+R,hi=`<${Ct}>`,J=document,de=(n="")=>J.createComment(n),ue=n=>n===null||typeof n!="object"&&typeof n!="function",Rt=Array.isArray,ci=n=>Rt(n)||typeof(n==null?void 0:n[Symbol.iterator])=="function",ee=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ht=/-->/g,ct=/>/g,L=RegExp(`>|[ 	
\f\r](?:([^\\s"'>=/]+)([ 	
\f\r]*=[ 	
\f\r]*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),pt=/'/g,vt=/"/g,Pt=/^(?:script|style|textarea|title)$/i,pi=n=>(e,...t)=>({_$litType$:n,strings:e,values:t}),S=pi(1),K=Symbol.for("lit-noChange"),$=Symbol.for("lit-nothing"),gt=new WeakMap,z=J.createTreeWalker(J,129,null,!1),vi=(n,e)=>{const t=n.length-1,i=[];let s,r=e===2?"<svg>":"",o=ee;for(let a=0;a<t;a++){const u=n[a];let f,d,h=-1,g=0;for(;g<u.length&&(o.lastIndex=g,d=o.exec(u),d!==null);)g=o.lastIndex,o===ee?d[1]==="!--"?o=ht:d[1]!==void 0?o=ct:d[2]!==void 0?(Pt.test(d[2])&&(s=RegExp("</"+d[2],"g")),o=L):d[3]!==void 0&&(o=L):o===L?d[0]===">"?(o=s!=null?s:ee,h=-1):d[1]===void 0?h=-2:(h=o.lastIndex-d[2].length,f=d[1],o=d[3]===void 0?L:d[3]==='"'?vt:pt):o===vt||o===pt?o=L:o===ht||o===ct?o=ee:(o=L,s=void 0);const b=o===L&&n[a+1].startsWith("/>")?" ":"";r+=o===ee?u+hi:h>=0?(i.push(f),u.slice(0,h)+"$lit$"+u.slice(h)+R+b):u+R+(h===-2?(i.push(void 0),a):b)}const l=r+(n[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return[ut!==void 0?ut.createHTML(l):l,i]};class he{constructor({strings:e,_$litType$:t},i){let s;this.parts=[];let r=0,o=0;const l=e.length-1,a=this.parts,[u,f]=vi(e,t);if(this.el=he.createElement(u,i),z.currentNode=this.el.content,t===2){const d=this.el.content,h=d.firstChild;h.remove(),d.append(...h.childNodes)}for(;(s=z.nextNode())!==null&&a.length<l;){if(s.nodeType===1){if(s.hasAttributes()){const d=[];for(const h of s.getAttributeNames())if(h.endsWith("$lit$")||h.startsWith(R)){const g=f[o++];if(d.push(h),g!==void 0){const b=s.getAttribute(g.toLowerCase()+"$lit$").split(R),y=/([.?@])?(.*)/.exec(g);a.push({type:1,index:r,name:y[2],strings:b,ctor:y[1]==="."?fi:y[1]==="?"?mi:y[1]==="@"?$i:Se})}else a.push({type:6,index:r})}for(const h of d)s.removeAttribute(h)}if(Pt.test(s.tagName)){const d=s.textContent.split(R),h=d.length-1;if(h>0){s.textContent=G?G.emptyScript:"";for(let g=0;g<h;g++)s.append(d[g],de()),z.nextNode(),a.push({type:2,index:++r});s.append(d[h],de())}}}else if(s.nodeType===8)if(s.data===Ct)a.push({type:2,index:r});else{let d=-1;for(;(d=s.data.indexOf(R,d+1))!==-1;)a.push({type:7,index:r}),d+=R.length-1}r++}}static createElement(e,t){const i=J.createElement("template");return i.innerHTML=e,i}}function Z(n,e,t=n,i){var s,r,o,l;if(e===K)return e;let a=i!==void 0?(s=t._$Co)===null||s===void 0?void 0:s[i]:t._$Cl;const u=ue(e)?void 0:e._$litDirective$;return(a==null?void 0:a.constructor)!==u&&((r=a==null?void 0:a._$AO)===null||r===void 0||r.call(a,!1),u===void 0?a=void 0:(a=new u(n),a._$AT(n,t,i)),i!==void 0?((o=(l=t)._$Co)!==null&&o!==void 0?o:l._$Co=[])[i]=a:t._$Cl=a),a!==void 0&&(e=Z(n,a._$AS(n,e.values),a,i)),e}class gi{constructor(e,t){this.u=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}v(e){var t;const{el:{content:i},parts:s}=this._$AD,r=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:J).importNode(i,!0);z.currentNode=r;let o=z.nextNode(),l=0,a=0,u=s[0];for(;u!==void 0;){if(l===u.index){let f;u.type===2?f=new ce(o,o.nextSibling,this,e):u.type===1?f=new u.ctor(o,u.name,u.strings,this,e):u.type===6&&(f=new yi(o,this,e)),this.u.push(f),u=s[++a]}l!==(u==null?void 0:u.index)&&(o=z.nextNode(),l++)}return r}p(e){let t=0;for(const i of this.u)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class ce{constructor(e,t,i,s){var r;this.type=2,this._$AH=$,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=s,this._$Cm=(r=s==null?void 0:s.isConnected)===null||r===void 0||r}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cm}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Z(this,e,t),ue(e)?e===$||e==null||e===""?(this._$AH!==$&&this._$AR(),this._$AH=$):e!==this._$AH&&e!==K&&this.g(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):ci(e)?this.k(e):this.g(e)}O(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}g(e){this._$AH!==$&&ue(this._$AH)?this._$AA.nextSibling.data=e:this.T(J.createTextNode(e)),this._$AH=e}$(e){var t;const{values:i,_$litType$:s}=e,r=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=he.createElement(s.h,this.options)),s);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===r)this._$AH.p(i);else{const o=new gi(r,this),l=o.v(this.options);o.p(i),this.T(l),this._$AH=o}}_$AC(e){let t=gt.get(e.strings);return t===void 0&&gt.set(e.strings,t=new he(e)),t}k(e){Rt(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,s=0;for(const r of e)s===t.length?t.push(i=new ce(this.O(de()),this.O(de()),this,this.options)):i=t[s],i._$AI(r),s++;s<t.length&&(this._$AR(i&&i._$AB.nextSibling,s),t.length=s)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const s=e.nextSibling;e.remove(),e=s}}setConnected(e){var t;this._$AM===void 0&&(this._$Cm=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class Se{constructor(e,t,i,s,r){this.type=1,this._$AH=$,this._$AN=void 0,this.element=e,this.name=t,this._$AM=s,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=$}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,s){const r=this.strings;let o=!1;if(r===void 0)e=Z(this,e,t,0),o=!ue(e)||e!==this._$AH&&e!==K,o&&(this._$AH=e);else{const l=e;let a,u;for(e=r[0],a=0;a<r.length-1;a++)u=Z(this,l[i+a],t,a),u===K&&(u=this._$AH[a]),o||(o=!ue(u)||u!==this._$AH[a]),u===$?e=$:e!==$&&(e+=(u!=null?u:"")+r[a+1]),this._$AH[a]=u}o&&!s&&this.j(e)}j(e){e===$?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class fi extends Se{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===$?void 0:e}}const _i=G?G.emptyScript:"";class mi extends Se{constructor(){super(...arguments),this.type=4}j(e){e&&e!==$?this.element.setAttribute(this.name,_i):this.element.removeAttribute(this.name)}}class $i extends Se{constructor(e,t,i,s,r){super(e,t,i,s,r),this.type=5}_$AI(e,t=this){var i;if((e=(i=Z(this,e,t,0))!==null&&i!==void 0?i:$)===K)return;const s=this._$AH,r=e===$&&s!==$||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,o=e!==$&&(s===$||r);r&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class yi{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Z(this,e)}}const ft=_e.litHtmlPolyfillSupport;ft==null||ft(he,ce),((ke=_e.litHtmlVersions)!==null&&ke!==void 0?ke:_e.litHtmlVersions=[]).push("2.4.0");const wi=(n,e,t)=>{var i,s;const r=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let o=r._$litPart$;if(o===void 0){const l=(s=t==null?void 0:t.renderBefore)!==null&&s!==void 0?s:null;r._$litPart$=o=new ce(e.insertBefore(de(),l),l,void 0,t!=null?t:{})}return o._$AI(n),o};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ne,Te;class se extends B{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=wi(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return K}}se.finalized=!0,se._$litElement$=!0,(Ne=globalThis.litElementHydrateSupport)===null||Ne===void 0||Ne.call(globalThis,{LitElement:se});const _t=globalThis.litElementPolyfillSupport;_t==null||_t({LitElement:se});((Te=globalThis.litElementVersions)!==null&&Te!==void 0?Te:globalThis.litElementVersions=[]).push("3.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
