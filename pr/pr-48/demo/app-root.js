 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const I=`{{lit-${String(Math.random()).slice(2)}}}`,Ot=`<!--${I}-->`,st=new RegExp(`${I}|${Ot}`),ne="$lit$";class ei{constructor(e,t){this.parts=[],this.element=t;const i=[],n=[],r=document.createTreeWalker(t.content,133,null,!1);let o=0,l=-1,a=0;const{strings:c,values:{length:v}}=e;for(;a<v;){const d=r.nextNode();if(d===null){r.currentNode=n.pop();continue}if(l++,d.nodeType===1){if(d.hasAttributes()){const h=d.attributes,{length:f}=h;let y=0;for(let m=0;m<f;m++)rt(h[m].name,ne)&&y++;for(;y-- >0;){const m=c[a],N=Fe.exec(m)[2],P=N.toLowerCase()+ne,A=d.getAttribute(P);d.removeAttribute(P);const M=A.split(st);this.parts.push({type:"attribute",index:l,name:N,strings:M}),a+=M.length-1}}d.tagName==="TEMPLATE"&&(n.push(d),r.currentNode=d.content)}else if(d.nodeType===3){const h=d.data;if(h.indexOf(I)>=0){const f=d.parentNode,y=h.split(st),m=y.length-1;for(let N=0;N<m;N++){let P,A=y[N];if(A==="")P=O();else{const M=Fe.exec(A);M!==null&&rt(M[2],ne)&&(A=A.slice(0,M.index)+M[1]+M[2].slice(0,-ne.length)+M[3]),P=document.createTextNode(A)}f.insertBefore(P,d),this.parts.push({type:"node",index:++l})}y[m]===""?(f.insertBefore(O(),d),i.push(d)):d.data=y[m],a+=m}}else if(d.nodeType===8)if(d.data===I){const h=d.parentNode;(d.previousSibling===null||l===o)&&(l++,h.insertBefore(O(),d)),o=l,this.parts.push({type:"node",index:l}),d.nextSibling===null?d.data="":(i.push(d),l--),a++}else{let h=-1;for(;(h=d.data.indexOf(I,h+1))!==-1;)this.parts.push({type:"node",index:-1}),a++}}for(const d of i)d.parentNode.removeChild(d)}}const rt=(s,e)=>{const t=s.length-e.length;return t>=0&&s.slice(t)===e},ti=s=>s.index!==-1,O=()=>document.createComment(""),Fe=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */class ot{constructor(e,t,i){this.__parts=[],this.template=e,this.processor=t,this.options=i}update(e){let t=0;for(const i of this.__parts)i!==void 0&&i.setValue(e[t]),t++;for(const i of this.__parts)i!==void 0&&i.commit()}_clone(){const e=it?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),t=[],i=this.template.parts,n=document.createTreeWalker(e,133,null,!1);let r=0,o=0,l,a=n.nextNode();for(;r<i.length;){if(l=i[r],!ti(l)){this.__parts.push(void 0),r++;continue}for(;o<l.index;)o++,a.nodeName==="TEMPLATE"&&(t.push(a),n.currentNode=a.content),(a=n.nextNode())===null&&(n.currentNode=t.pop(),a=n.nextNode());if(l.type==="node"){const c=this.processor.handleTextExpression(this.options);c.insertAfterNode(a.previousSibling),this.__parts.push(c)}else this.__parts.push(...this.processor.handleAttributeExpressions(a,l.name,l.strings,this.options));r++}return it&&(document.adoptNode(e),customElements.upgrade(e)),e}}/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const lt=window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:s=>s}),ii=` ${I} `;class Ht{constructor(e,t,i,n){this.strings=e,this.values=t,this.type=i,this.processor=n}getHTML(){const e=this.strings.length-1;let t="",i=!1;for(let n=0;n<e;n++){const r=this.strings[n],o=r.lastIndexOf("<!--");i=(o>-1||i)&&r.indexOf("-->",o+1)===-1;const l=Fe.exec(r);l===null?t+=r+(i?ii:Ot):t+=r.substr(0,l.index)+l[1]+l[2]+ne+l[3]+I}return t+=this.strings[e],t}getTemplateElement(){const e=document.createElement("template");let t=this.getHTML();return lt!==void 0&&(t=lt.createHTML(t)),e.innerHTML=t,e}}/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */class ai{handleAttributeExpressions(e,t,i,n){const r=t[0];return r==="."?new si(e,t.slice(1),i).parts:r==="@"?[new oi(e,t.slice(1),n.eventContext)]:r==="?"?[new ni(e,t.slice(1),i)]:new Ut(e,t,i).parts}handleTextExpression(e){return new Se(e)}}const di=new ai;/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function ui(s){let e=at.get(s.type);e===void 0&&(e={stringsArray:new WeakMap,keyString:new Map},at.set(s.type,e));let t=e.stringsArray.get(s.strings);if(t!==void 0)return t;const i=s.strings.join(I);return t=e.keyString.get(i),t===void 0&&(t=new ei(s,s.getTemplateElement()),e.keyString.set(i,t)),e.stringsArray.set(s.strings,t),t}const at=new Map;/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const dt=new WeakMap,ci=(s,e,t)=>{let i=dt.get(e);i===void 0&&(Pt(e,e.firstChild),dt.set(e,i=new Se(Object.assign({templateFactory:ui},t))),i.appendInto(e)),i.setValue(s),i.commit()};/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */typeof window!="undefined"&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.4.1");const hi=(s,...e)=>new Ht(s,e,"html",di);/*! *****************************************************************************
